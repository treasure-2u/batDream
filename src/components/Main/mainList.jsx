    ...
    <div>
      ...
      <div className="image-container">
        ...
        <div className="description">
          <h3>추천작물</h3>
          <p>
            주말농장에서는 다양한 작물을 재배할 수 있습니다. 여기에는 주변
            환경에 적합한 토마토, 상추, 당근 등의 작물을 재배하는 것을
            추천합니다.
          </p>
          <p>
            이러한 작물들은 특별한 관리가 필요하지 않으며, 주말농장에서 즐겁고
            손쉽게 재배할 수 있습니다. 더 나은 환경을 위해 자연친화적인 방법으로
            재배할 수 있는 팁도 함께 제공됩니다.
          </p>
        </div>
      </div>
