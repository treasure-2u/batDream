    ...
    <header className="header">
      <div className="container">
        ...
        <div className="icon-container">
          <Leaf className="icon" />
          <Link to="#" className="header-link" id="color1">
            주말농장
          </Link>
        </div>
        <div className="icon-container">
          <Book className="icon" />
          <Link to="#" className="header-link" id="color2">
            식물도감
          </Link>
        </div>
        <div className="icon-container">
          <BadBook className="icon" />
          <Link to="#" className="header-link" id="color3">
            유해충도감
          </Link>
        </div>
        <div className="icon-container">
          <Notice className="icon" />
          <Link to="#" className="header-link" id="color4">
            공지사항
          </Link>
        </div>
      </div>
